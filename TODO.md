...
Repository: https://github.com/RanaPriyansh/thielon-agent-workflow.git
Canonical local path: /root/git-repos/agent-workflow
Default branch: main
...
3. Run the local setup path for agent-workflow and write exact commands back into README if they are missing or stale.
